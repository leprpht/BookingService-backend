...
public class ReviewRepository(BookingServiceDbContext context) : IReviewRepository
{
    ...
    public async Task<List<(PropertyReview PropertyReview, Guest Guest)>> GetReviewsByUserIdAsync(int id, PageRequest pageRequest)
    {
        var pagedReviews = await context.PropertyReviews
